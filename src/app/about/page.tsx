          ...
          <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
            ...
            <div className="md:pt-8">
              ...
              <p className="mb-6 text-gray-500 dark:text-slate-200 sm:text-lg md:mb-8">
                ...
                impedit. Rem iusto tempore tempora nobis nostrum, consequatur
                ipsum. Mollitia, ea inventore. Perferendis blanditiis quam quos
                architecto? Quod eveniet dolorem corporis.
                <a
                  href="#"
                ...
                or Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                Aut, sunt!
              </p>
