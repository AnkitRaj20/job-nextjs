  ...
  return (
    <>
      ...
      <div
        ...
        data-url="8rm4k8wm-website-contact-form"
        data-domain="forms"
          ...
          <div className="container flex flex-col flex-1 px-6 py-12 mx-auto">
            <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
              <div className="text-white lg:w-1/2 lg:mx-6">
                ...
                Feel free to reach out to us anytime! Our dedicated support team is here to assist you with any questions, concerns, or feedback you may have. Your satisfaction is our priority, and we value your input. Contact us through the provided form, and we'll get back to you promptly. Your insights are essential in helping us enhance your experience. Thank you for choosing us, and we look forward to connecting with you!</p>
              ...
              <div className="mt-8 lg:w-1/2 lg:mx-6">
                <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                  ...
                  <form
                    method="POST"
                    className=" w-full px-4 mt-6 lg:px-0 mx-auto"
                ...
                >
                  {errors.fullName && (
                    <p className="bg-red-500 text-white  rounded w-full text-center">
                ...
                >
                  {errors.email && (
                    <p className="bg-red-500 mt-2 text-white  rounded w-full text-center">
