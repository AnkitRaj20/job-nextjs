        ...
        <div className="m-5">
          {loading ? (
            <div
              aria-label="Loading..."
              role="status"
              className="flex justify-center content-center items-center space-x-2"
            >
              <svg
              ...
              {data.map((item: any) => {
                return (
                  <div key={item.job_id} className=" m-5 shadow-2xl" onClick={() => detailPage(item.job_id)}>
                    <div
                      className="flex flex-col h-80 max-w-lg p-6 space-y-6 overflow-hidden rounded-lg  capitalize shadow-2xl bg-gray-50 text-gray-800 
                      ...
                      <div>
                        ...
                        <div className="flex items-center flex-wrap ">
                          <a
                            ...
                            target="_blank"
                            className=" inline-flex items-center mt-2 md:mb-2 lg:mb-0 font-medium space-x-5"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 512 512"
                            ...
                            <p className="leading-relaxed lowercase text-base">
                              {item.job_apply_link}
                            </p>
                          </a>
                        </div>
