        ...
        <div className="lg:w-1/2 xl:max-w-screen-sm bg-white dark:bg-dark">
          <div className="mt-10 bg-white dark:bg-dark
           px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
            <h2
              className="text-center text-4xl text-indigo-900 dark:text-white font-display font-semibold lg:text-left xl:text-5xl
                    xl:text-bold"
            >
              {loading ? (
            ...
            <div className="mt-12">
              <form method="POST">
                <div>
                  <div className="text-sm font-bold dark:text-slate-200 text-gray-700 tracking-wide">
                    Email Address
                  </div>
                  <input
                ...
                <div className="mt-8">
                  <div className="flex justify-between items-center">
                    ...
                    <div>
                      <a
                        className="text-xs font-display font-semibold text-indigo-600 hover:text-indigo-800 dark:text-indogo-200
                                        cursor-pointer"
                      >
                        Forgot Password?
                      </a>
              ...
              <div className="mt-12 text-sm font-display font-semibold text-gray-700 dark:text-white text-center">
                ...
                <Link
                  href="/employerSignup"
                  className="cursor-pointer text-indigo-600 hover:text-indigo-800 dark:text-indigo-200"
                >
                  Sign up
                </Link>
              </div>
