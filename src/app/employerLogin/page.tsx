          ...
          <div className="mt-10 bg-white px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
            <h2
              className="text-center text-4xl text-indigo-900 font-display font-semibold lg:text-left xl:text-5xl
                    xl:text-bold"
            >
              {loading ? <div className="w-16 h-16 border-4 border-dashed rounded-full animate-spin border-violet-400 justify-center text-center"></div> : "Employer Login"}
            </h2>
            <div className="mt-12">
              <form method="POST">
                <div>
              ...
              <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
               ...
               <Link href="/employerSignup" className="cursor-pointer text-indigo-600 hover:text-indigo-800"> 
                  Sign up
                </Link>
              </div>
            </div>
