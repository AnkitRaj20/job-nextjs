...
const Navbar = () => {
  return (
    ...
    <header className="text-gray-600 bg-white body-font ">
      <div className="container justify-between mx-auto flex flex-wrap pl-3 flex-col md:flex-row items-center">
        <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
          ...
          <Image src={Logo} height={100} width={100} alt="logo" className="rounded text-xl"/>
        </a>
