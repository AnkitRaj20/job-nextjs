...
export default () => {
    ...
    return (
        <section className="py-14 dark:text-white">
            <div className="max-w-screen-xl dark:text-white mx-auto px-4 text-gray-600 gap-x-12 items-start justify-between lg:flex md:px-8">
